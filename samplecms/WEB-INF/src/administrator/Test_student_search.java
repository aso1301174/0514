...
public class Test_student_search extends HttpServlet {
	...
	throws ServletException, IOException {
		...
		try {
			...
			ResultSet rs = null;
			//SQL文設定の準備・SQL文の実行
			String selectSql = "select * from test order by test_id;";
			...
			RequestDispatcher rd = request.getRequestDispatcher("./administrator/t-s_search.jsp");
